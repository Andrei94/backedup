...
public class DummyAWSCognitoIdentityProvider implements AWSCognitoIdentityProvider {
	@Override
	...
	@Override
	public AdminSetUserPasswordResult adminSetUserPassword(AdminSetUserPasswordRequest adminSetUserPasswordRequest) {
		throw new UnsupportedOperationException();
	}
	...
	@Override
	public UpdateUserPoolDomainResult updateUserPoolDomain(UpdateUserPoolDomainRequest updateUserPoolDomainRequest) {
		throw new UnsupportedOperationException();
	}
